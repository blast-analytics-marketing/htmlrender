...
func TestRenderer_withElementAndAttributeExclusion(t *testing.T) {
	nodes := [...]*html.Node{
		0: {
			Type: html.ElementNode,
			Data: "html",
...
func TestRenderer_withMultipleClassesd(t *testing.T) {
	nodes := [...]*html.Node{
		0: {
			Type: html.ElementNode,
			Data: "html",
	...
	treeAsText := [...]string{
		...
		2: `.	<body>`,
		3: `.	.	"0&lt;1"`,
		4: `.	.	<div class="primary secondary tertiary">`,
		5: `.	.	.	"2"`,
		6: `.	.	.	<b empty="">`,
		7: `.	.	.	.	"3"`,
		8: `.	.	.	<i backslash="\">`,
